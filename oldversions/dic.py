...
def MatchSubsetCentres(F1, F1_ROI_padded, F2):
    ...
    Xk1, Xk2, Xo1, N_subsets, kp1, kp2, d1, d2 = SIFTquick(F1_ROI_padded, F2)
    #robust matching of keypoints between images
    Xk1, Xk2, p_matches = KeypointMatchRobust(Xk1, Xk2, kp1, kp2, d1, d2)
    ...
    #between images using affine transformation model
    P0_stereo = MatchSubCentresAffine(F1, N_subsets, Xk1, Xk2, kNN_indices) 
